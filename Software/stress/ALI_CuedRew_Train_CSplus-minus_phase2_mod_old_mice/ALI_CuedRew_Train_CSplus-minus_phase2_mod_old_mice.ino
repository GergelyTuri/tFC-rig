...
//variable ITI 
//By US 9/24/22
//Adding hapttic motor control to the beginning of the trials; Turi 4/7/2025
#include <Wire.h>
...
int ITI_array = 0;
int ITI[] = {24,21,30,26,25,24,21,30,24,24,20,22,25,28,28,
  23,24,24,25,18,27,22,28,25,26,29,31,22,23,29,28,23,25,22,
  16,25,27,23,23,19,25,27,25,20,27,22,19,25,22,27,25,25,24,
  27,23,21,26,21,26,25,22,26,23,30,27,22,25,27,25,25,26,19,
  23,24,21,24,19,28,26,21,25,31,28,22,25,21,23,24,23,22,27,
  26,21,22,19,24,26,19,29,24,27,25,23,31,26,27,25,25,22,26,
  25,30,25,25,31,23,24,22,26,23,19,27,20,28,25,21,29,25,27,
  26,24,20,22,29,23,29,20,24,29,25,30,26,27,29,22,30,23,28,
  19,21,32,28,26,24,28,17,25,26,27,27,22,22,28,26,26,22,19,
  27,25,27,21,25,26,27,21,21,27,26,23,24,21,28,24,25,23,24,
  28,20,25,22,25,29,27,22,28,20,23,20,23,32,25,21,30,23,21,
  21,23,20,27,18,25,24,27,22,27,27,23,28,32,26,23,22,26,25,
  19,25,28,26,17,23,21};
...
const uint8_t HAPTIC_EFFECT_ID = 1;
const unsigned long START_DELAY_MS = 10000;
...
void triggerHaptic(uint8_t effectID) {
  drv.setWaveform(0, effectID);  // Load effect
...
if (millis() >  SessionTime) {  //End Program
 ...
 if (trialNum >= 1) {
 Serial.print("Trial ");
 triggerHaptic(1); // Trigger haptic feedback at the start of each trial
