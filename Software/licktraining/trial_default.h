...
const long MIN_ITI = 6;
const long MAX_ITI = 30;
const long TRIAL_DURATION = 1800000;
const long POST_LAST_TRIAL_INTERVAL = 6;
...
// Air puff settings
const bool USING_AIR_PUFFS = false;
...
// Auditory settings
const bool USING_AUDITORY_CUES = false;
